...
angular.module('myApp', [])
  ...
  .controller('mainController', ['$anchorScroll', '$location', '$scope',
   ...
   $scope.gotoAnchor('anchorcw');
    ...
    $scope.about_1 ='A full-stack web developer pursuing exciting new opportunities.'
    $scope.about_2= 'Have great passion on product and related design. '
    $scope.about_3="With the ability to thrive in a fast-paced environment, willing to give 100% to help the team succeed"
